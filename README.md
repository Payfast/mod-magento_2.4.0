...
PayFast Magento Module v2.0.0 for Magento 2.4.0
-----------------------------------------------------------------------------
...
In order to use PayFast 2.0.0 with Magento 2.4.0 you will need a working Magento 2.4.0 installation. To install PayFast follow the below instructions:
